...
public class TestDragNDropFiles {
    ...
    public static class DropPane extends JPanel {
        ...
        protected void paintComponent(Graphics g) {
            ...
            if (dragOver) {
                ...
                if (dragPoint != null && target != null) {
                    var x = dragPoint.x - 12;
                    var y = dragPoint.y - 12;
        ...
        protected void importFiles(final List<File> files) {
            SwingUtilities.invokeLater(() -> message.setText("You dropped " + files.size() + " files"));
        }
            ...
            public void drop(DropTargetDropEvent dtde) {
                ...
                if (dtde.isDataFlavorSupported(DataFlavor.javaFileListFlavor)) {
                    ...
                    try {
                        ...
                        @SuppressWarnings("unchecked") var transferData = (List<File>) transferable.getTransferData(DataFlavor.javaFileListFlavor);
